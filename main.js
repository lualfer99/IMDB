...
var actriz2 = new profesional_1.Professional("Scarlett Johannsson", 35, "Woman", 56, 1.60, "Brown", "Green", "White", false, "American", 1, "Actress");
var actriz3 = new profesional_1.Professional("Rooney Mara", 35, "Woman", 54, 1.65, "Brown", "Green", "White", false, "American", 0, "Actress");
var cast1 = [actor1.name, actriz2.name, actor3.name];
var cast2 = [actor4.name, actriz2.name, actriz3.name];
var cast3 = [actor2.name, actriz1.name, actor5.name];
// "The Big Short" Movie
